...
public class Flywheel extends SubsystemBase {
  ...
  private final LinearSystem<N1, N1, N1> m_flywheelPlant = LinearSystemId.identifyVelocitySystem(Constants.kFlywheelKV,
      Constants.kFlywheelKA);
  private final KalmanFilter<N1, N1, N1> m_observer = new KalmanFilter<>(
      Nat.N1(),
      Nat.N1(),
      m_flywheelPlant,
      VecBuilder.fill(3.0), // can increase this to causes filted to distrust our state estimate and favor
                            // new measurments more highly
